 ...
 * 
 */
function showDisasterPoint(map , disasterPointUrl , year ,month ,day ,areaDisasterPoint) {
	 require(["esri/map",
				...
				Color ,Graphic) {
				    ...
				    //判断条件，必须，一般选择FID >-1即可
				    query.where = "YEAR_= " + year + " and MONTH_= " + month + " and DAY_ = " + day + " and ZHOU = '" + areaDisasterPoint + "'";
