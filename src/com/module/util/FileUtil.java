...
public class FileUtil {
	 ...
	 */
	/*
	 * public static File[] listAll(File file) { ArrayList list = new ArrayList();
	 * File[] files; if (!file.exists() || file.isFile()) { return null; }
	 * list(list, file, new AllFileFilter()); list.remove(file); files = new
	 * File[list.size()]; list.toArray(files); return files; }
	 */
